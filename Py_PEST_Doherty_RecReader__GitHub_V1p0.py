"""     Python PEST Post Processor to Read Raw RMR Output File and Create a Pandas DataFrame Summizing Run Times
             ...
             Last Updated 09/12/2019 (September, I am from the US)
...
This program takes the raw output text files from PEST and creates a Pandas DataFrame and graphs.
   ...
   -CURRENTLY HARD CODED FILENAME AND FOLDER, NEEDS TO BE UPDATED!
   
This tool was designed for use by Arizona Department of Water Resources (ADWR) Groundwater Flow 
and Transport Modelers to Post Process the results of MODFLOW Models and PEST Calibration Runs.
"""
import os
import pandas as pd
import numpy as np
...
#
##CHECK PATH AND MOVE TO FOLDER WITH THE DATA (NOT NECESSARY, THIS PROGRAM DEFINES FULL PATHS FOR INPUT FILES)
cwd = os.getcwd()
Path = r"J:\HYDRO\pythonShare\Programs\JustinClark\PESTJD_OutReader\REC_File_TEST\Pinal_AMA"
os.chdir(Path)
cwd = os.getcwd()

#
##DEFINE THE NAME OF THE PEST RUN and assign it to the .rec and .rmr files
#PESTcase = "tucsonmodel_v4_2_2"
PESTcase = "pinalmodel_v3_6_3c"
